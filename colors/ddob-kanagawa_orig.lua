...
local syntaxgroups = {
  -- *Comment	any comment
  Comment = vim.tbl_extend("force", { fg = theme.syn.comment_documentation }, config.commentStyle),
  ...
  Function = vim.tbl_extend("force", { fg = theme.syn.func_builtin }, config.functionStyle),
